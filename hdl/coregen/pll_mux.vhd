...
-- Module  Version: 5.7
--C:\lscc\diamond\3.6_x64\ispfpga\bin\nt64\scuba.exe -w -n pll_mux -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 160 -fclkop 160 -fclkop_tol 0.0 -fclkos 160 -fclkos_tol 0.0 -fclkos2 40 -fclkos2_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 90 -trims_r -phases2 0 -phase_cntl STATIC -fb_mode 1 -lock 

-- Mon Nov 09 17:54:39 2015
...
architecture Structure of pll_mux is
    ...
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "160.000000";
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "160.000000";
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "160.000000";
    attribute ICP_CURRENT of PLLInst_0 : label is "14";
    attribute LPF_RESISTOR of PLLInst_0 : label is "4";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS2_FPHASE=>  0, CLKOS2_CPHASE=>  11, CLKOS_FPHASE=>  6, 
        ...
        CLKOP_ENABLE=> "ENABLED", CLKOS3_DIV=>  1, CLKOS2_DIV=>  12, 
        CLKOS_DIV=>  3, CLKOP_DIV=>  3, CLKFB_DIV=>  1, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of pll_mux is
    for Structure
